...
if __name__ == '__main__':
    ...
    if opt.test:
        ...
        name="Test/"+"warmstart_OURS_"+model.activation+time_stamp+"_lr_"+str(opt.lr_new)+opt.path_new.split("/")[-1].split(".")[0]
        ...
        trainer.save_mesh(os.path.join(opt.workspace, 'results', 'output0.ply'), 1024)
